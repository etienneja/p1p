...
export function Footer() {
  return (
    <footer className="bg-encre text-cream">
            ...
            <ul className="space-y-2">
              {navigation.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-cream/70 hover:text-corail transition-colors text-sm"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                ...
                className="text-cream/70 hover:text-corail transition-colors"
                aria-label="Facebook"
              >
                <FacebookIcon />
              </a>
